...
class ListingViolationApi
{
    ...
    public function getListingViolationsRequest($x_ebay_c_marketplace_id, $compliance_type = null, $offset = null, $listing_id = null, $limit = null, $filter = null)
    {
        ...
        if ($compliance_type !== null) {
            if('form' === 'form' && is_array($compliance_type)) {
                foreach($compliance_type as $key => $value) {
        ...
        // query params
        if ($listing_id !== null) {
            if('form' === 'form' && is_array($listing_id)) {
     ...
     *
     * @param  \eBay\Sell\Compliance\Model\SuppressViolationRequest $suppress_violation_request This type is the base request type of the SuppressViolation method. (required)
     *
     * @throws \eBay\Sell\Compliance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    public function suppressViolationRequest($suppress_violation_request)
    {
        ...
        if ($suppress_violation_request === null || (is_array($suppress_violation_request) && count($suppress_violation_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $suppress_violation_request when calling suppressViolation'
            );
        }
